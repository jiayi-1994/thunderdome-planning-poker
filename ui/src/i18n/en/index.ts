...
const en = {
  ...
  importStoriesUI: {
    description: 'Choose your preferred method to import planning poker stories',
    internalImport: 'Internal Import',
    subscriptionDescription: 'Import stories from other Planning Poker sessions or Storyboards.',
    fromGame: 'Import from Game',
    fromStoryboard: 'Import from Storyboard',
    fromJiraCloud: 'Import from Jira Cloud',
    fileImport: 'File Import',
    jiraXmlDescription: 'Import stories from Jira XML export files',
    csvDescription: 'CSV files must include these fields in order (header row optional):',
    ...
    selectGame: 'Select game to import from',
    selectStoryboard: 'Select storyboard to import from',
    selectGoal: 'Select goal to import from',
    gameNotSelected: 'Game not selected',
    storyboardNotSelected: 'Storyboard not selected',
    importStory: 'Import',
  ...
  jiraImportUI: {
    subscriptionPitch: 'Import your stories for Poker Planning from Jira.',
    subscriptionExpired: 'Your subscription has expired.',
    instancesError: 'Failed to get Jira instances.',
    setupPrompt: 'Set up a Jira instance on your profile page to import stories.',
    profilePage: 'Open profile page',
    selectInstance: 'Select Jira Instance to import from',
    searchMode: 'Search mode',
    basicFilters: 'Basic filters',
    advancedJQL: 'Advanced JQL',
    advancedHint: 'Write a JQL query here. Basic filters are kept separately; switching back restores your filter selections.',
    queryPreview: 'Query preview',
    issueType: 'Issue type',
    allIssueTypes: 'All issue types',
    loadingIssueTypes: 'Loading issue types...',
    issueTypesError: 'Could not load issue types. Retry or use Advanced JQL.',
    retryIssueTypes: 'Retry issue types',
    noIssueTypes: 'No issue types are available. You can search with Advanced JQL.',
    sprintSearchLabel: 'Find a sprint by name',
    sprintQueryPlaceholder: 'Enter a sprint name, e.g. Sprint41',
    sprint: 'Sprint',
    allSprints: 'All sprints',
    findSprints: 'Find sprints',
    loadingSprints: 'Loading sprints...',
    sprintsError: 'Could not load sprints. Retry or use Advanced JQL.',
    retrySprints: 'Retry sprints',
    noSprints: 'No matching sprints. Try another name or use Advanced JQL.',
    sprintsHint: 'Includes active, upcoming and completed sprints. Search by name to find more.',
    sprintActive: 'Active',
    sprintFuture: 'Upcoming',
    sprintClosed: 'Completed',
    sprintUnknown: 'Unknown status',
    searchLabel: 'Search JQL',
    queryPlaceholder: 'Enter Search JQL...',
    queryRequired: 'Enter a JQL query, for example: order by created DESC',
    search: 'Search',
    searching: 'Searching...',
    searchingHint: 'Fetching stories from Jira. Large result sets may take a while; please wait.',
    searchError: 'Jira search failed. Please try again.',
    searchErrorDetails: 'Jira JQL Search Error: {error}' as const,
    noStories: 'No stories found for this JQL query.',
    allImported: 'All stories have been imported!',
    searchResults: 'Search Results ({count})' as const,
    importAll: 'Import All',
    importStory: 'Import',
    commonConditions: 'Common JQL conditions',
    examplesHint:
    ...
    combinedExample: 'Combined example',
    examples: {
      sprint: 'Specific sprint',
      activeSprint: 'Active sprints',
      project: 'Project key',
      assignee: 'Assigned to the connected Jira account',
      status: 'Status',
      issueType: 'Issue type',
